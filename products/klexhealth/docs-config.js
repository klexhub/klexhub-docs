module.exports = {
  ...
  contentRepo: "klexhealth/developers.klexhealth.com",
  contentRepoFolder: "",
  externalLinks: [
    {
      title: "Website",
  ...
  siteMetadata: {
    title: "Example docs",
    description:
      "These docs are an example of of a docs site built with https://github.com/cloudflare/workers-docs-engine.",
    author: "@KlexHealth",
